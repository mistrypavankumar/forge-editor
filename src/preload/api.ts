...
export const api: ForgeApi = {
  ...
  capturePage: (rect) => ipcRenderer.invoke(IpcChannels.capturePage, rect),
  clipboardWriteImage: (dataUrl) => ipcRenderer.invoke(IpcChannels.clipboardWriteImage, dataUrl),
